...
class TestGNOMEChecker(unittest.IsolatedAsyncioTestCase):
    ...
    def test_major_scheme_is_stable(self):
        scheme = VersionScheme.ODD_MAJOR_IS_UNSTABLE
        self.assertTrue(_is_stable("1", scheme))
        self.assertTrue(_is_stable("2", scheme))
        self.assertTrue(_is_stable("2.1", scheme))
        self.assertTrue(_is_stable("2.2", scheme))
        self.assertTrue(_is_stable("4.1", scheme))
        self.assertTrue(_is_stable("4.2", scheme))
        self.assertTrue(_is_stable("2.1.1", scheme))
        self.assertTrue(_is_stable("2.2.1", scheme))
        self.assertTrue(_is_stable("4.1.1", scheme))
        self.assertTrue(_is_stable("4.2.1", scheme))
        self.assertTrue(_is_stable("2.1.2", scheme))
        self.assertTrue(_is_stable("2.2.2", scheme))
        self.assertTrue(_is_stable("4.1.2", scheme))
        self.assertTrue(_is_stable("4.2.2", scheme))

        self.assertFalse(_is_stable("1.1", scheme))
        self.assertFalse(_is_stable("1.2", scheme))
        self.assertFalse(_is_stable("3.1", scheme))
        self.assertFalse(_is_stable("3.2", scheme))
        self.assertFalse(_is_stable("1.1.1", scheme))
        self.assertFalse(_is_stable("1.2.1", scheme))
        self.assertFalse(_is_stable("3.1.1", scheme))
        self.assertFalse(_is_stable("3.2.1", scheme))
        self.assertFalse(_is_stable("1.1.2", scheme))
        self.assertFalse(_is_stable("1.2.2", scheme))
        self.assertFalse(_is_stable("3.1.2", scheme))
        self.assertFalse(_is_stable("3.2.2", scheme))
